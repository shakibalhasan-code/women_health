  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Obx(() => Padding(
              // Use Obx to react to controller changes
                ...
                children: [
                      ...
                      children: communityController.categories.map((category) {
                        ...
                        return Padding(
                          padding: EdgeInsets.only(
                              right: 8.w), // Spacing between items
                  ...
                  TextField(
                    controller: communityController
                        .editTitleController, // Use EDIT controller
                    decoration: InputDecoration(
                      hintText: post.title, // Set initial value from post
                  ...
                  TextField(
                    controller: communityController
                        .editDescriptionController, // Use EDIT controller
                    decoration: InputDecoration(
                      hintText: post.description, // Set initial value from post
                      hintStyle: TextStyle(color: Colors.grey.shade400),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8.r),
                        borderSide: BorderSide(color: Colors.grey.shade300),
                  ...
                  Obx(() {
                    final newImagePath =
                        communityController.selectedImage.value?.path;
                        ...
                        GestureDetector(
                          onTap: () async {
                            await communityController
                                .pickImage(); // Use specific picker for edit
                          },
                          child: Row(
                            children: [
                  ...
                  Center(
                    child: Obx(() => ElevatedButton(
                          // Obx for loading state
                          onPressed: communityController.isUpdating.value
                              ? null
                              : () {
                                  // Call update method from controller
                                  communityController
                                      .postEdit(post.id!); // Pass the post ID
                                },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.red,
                            disabledBackgroundColor:
                                Colors.red.shade200, // Disabled color
